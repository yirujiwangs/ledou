...
//		System.out.println("currentHour : "+ currentHour);
	 ...
	 * @return
	 */
	public static JSONObject getWxDevStatistics(Token token,TokenMapper tokenMapper,long datetime,int pageIdx){
	...
	//批量申请50个微信Id
	public static JSONObject applyWeixinId(Token token,TokenMapper tokenMapper){
		String accessToken=getAccessToken(token,tokenMapper);
		//System.out.println("当前token--"+accessToken);
