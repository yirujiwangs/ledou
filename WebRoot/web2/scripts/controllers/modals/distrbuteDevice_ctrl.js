(function(){
    ...
    angular
        .module('center')
        .controller('DistrbuteDeviceCtrl', DistrbuteDeviceCtrl);

    DistrbuteDeviceCtrl.$inject = [ '$scope', '$rootScope','$route','$modalInstance','shopData','AlertService','dataService','deviceService'];

    function DistrbuteDeviceCtrl($scope,$rootScope,$route,$modalInstance,shopData,AlertService,dataService,deviceService){
        var vm = this;
        // 已选择设备数
        vm.choiceNum = 0;
        // 商家名称和商家账号
        console.log(shopData);
        vm.storeName = shopData.storeName;
        vm.account = shopData.account;
