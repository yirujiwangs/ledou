(function () {
    ...
    angular
        .module('center')
        .controller('ListAdCtrl', ListAdCtrl);

    ListAdCtrl.$inject = ['$scope','$route', '$rootScope', 'AdService', 'dataService', '$modal', 'utilService', '$location', 'AlertService','$timeout'];

    function ListAdCtrl($scope,$route, $rootScope, AdService, dataService, $modal, utilService, $location, AlertService,$timeout) {
        var vm = this;
        // 分页
        vm.currentPage = 1;
        vm.totalPage = 1;
        ...
        vm.titles = dataService.listAdTitles;
        ...
        vm.handle = function(index){
            ...
            //vm.status = vm.allAdRecord[index].status;
