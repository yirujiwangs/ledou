(function(){
    ...
    AccountEditCtrl.$inject = [ '$scope', '$rootScope','dataService','$location','$modalInstance','shopData','utilService','$modal','AlertService','accountService'];

    function AccountEditCtrl($scope,$rootScope,dataService,$location,$modalInstance,shopData,utilService,$modal,AlertService,accountService){
    	var vm=this;
    	...
    	$scope.form=shopData;
         console.log($scope.form ,"ffjjfj",shopData);
